...
-- 1. USERS
INSERT INTO "User" (id, name, phone, points, created_at) VALUES
(1, 'Bagas', '0812-3456-7890', 145, NOW());

-- 2. ACCOUNTS (password di-hash dengan Argon2id)
INSERT INTO "Account" (id, username, password_hash, role, user_id, created_at) VALUES
...
-- 4. BOOKINGS
INSERT INTO "Booking" (id, queue_number, owner_name, motor, plate, service_type, appointment_date, appointment_time, status, base_price, created_at, user_id, mechanic_id) VALUES
...
-- 5. FINDINGS
INSERT INTO "Finding" (id, booking_id, name, note, price, photo_url, status) VALUES
...
-- 8. SPAREPARTS
INSERT INTO "Sparepart" (id, name, category, price, stock, description, image_url, created_at, updated_at) VALUES
